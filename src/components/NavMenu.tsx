...
export function NavMenu(props: NavMenuProps) {
  return (
    <nav
      ...
      <ul class="flex flex-col h-full justify-center space-y-8 text-center md:flex-row md:space-y-0 md:space-x-12 -ml-9">
        <li>
          <a href="#hero" class="text-gray-800 relative group">
            <span>Home</span>
        ...
        <li>
          <a href="#about" class="text-gray-800 relative group">
            <span>About</span>
            <span class="absolute inset-x-0 bottom-0 h-0.5 bg-iconColors-hover transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
          </a>
        </li>
